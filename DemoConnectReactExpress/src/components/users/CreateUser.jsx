...
const CreateUser = () => {
  return (
    <form className= ' relative bg-blue-300 py-4 w-[600px] rounded-lg  m-auto flex justify-center items-center shadow-lg shadow-black'>
        ...
        <button className='text-white font-bold bg-red-600 w-[200px] py-2 rounded-lg m-auto hover:bg-red-800'>Thêm người dùng</button>
        </div>
